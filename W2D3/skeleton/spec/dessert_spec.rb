...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("brownie", "non-integer", chef) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      brownie.add_ingredient("pizza")
      brownie.add_ingredient("senior thesis")
      brownie.add_ingredient("potato salad")
      expect(brownie.mix!).to_not eq(["pizza", "senior thesis", "potato salad"])
    end
  end
